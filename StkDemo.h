...
// Attributes
public:
	void TmpAskStockDay(char*  pszStockCode,int nTimePeriod);
	void TmpAskStockMn5(char*  pszStockCode,int nTimePeriod);
	void TmpAskStockBase(char*  pszStockCode);
	void TmpAskStockNews();
	void TmpAskStockHalt();
	void TmpAskStockMin(char*  pszStockCode);
	void TmpAskStockPRP(char*  pszStockCode);
	void TmpAskStockPwr();
	void TmpAskStockFin();
// Operations
public:
